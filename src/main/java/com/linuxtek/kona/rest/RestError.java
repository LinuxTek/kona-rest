...
public class RestError {
    ...
    public RestError(HttpStatus status, int code, String clientMessage, String developerMessage, String moreInfoUrl, Throwable throwable) {
        if (status == null) {
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof RestError) {
            ...
            return ObjectUtils.nullSafeEquals(getStatus(), re.getStatus()) &&
                    getCode() == re.getCode() &&
                    ObjectUtils.nullSafeEquals(getClientMessage(), re.getClientMessage()) &&
    ...
    public int hashCode() {
        ...
        return ObjectUtils.nullSafeHashCode(new Object[]{
                getStatus(), getCode(), getClientMessage(), getDeveloperMessage(), getMoreInfoUrl(), getThrowable()
        });
    }
    ...
    public static class Builder {
        ...
        public RestError build() {
            ...
            return new RestError(this.status, this.code, this.clientMessage, this.developerMessage, this.moreInfoUrl, this.throwable);
        }
    }
}
