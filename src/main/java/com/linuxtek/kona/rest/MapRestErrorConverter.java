...
public class MapRestErrorConverter implements RestErrorConverter<Map<String,Object>> {
    ...
    private static final String DEFAULT_CLIENT_MESSAGE_KEY = "client_message";
    private static final String DEFAULT_DEVELOPER_MESSAGE_KEY = "developer_message";
    //private static final String DEFAULT_MORE_INFO_URL_KEY = "more_info_url";
    private static final String DEFAULT_MORE_INFO_URL_KEY = "reference_url";

    private String statusKey = DEFAULT_STATUS_KEY;
    private String codeKey = DEFAULT_CODE_KEY;
    private String clientMessageKey = DEFAULT_CLIENT_MESSAGE_KEY;
    ...
    public Map<String, Object> convert(RestError re) {
        ...
        String message = re.getClientMessage();
        if (message != null) {
            m.put(getClientMessageKey(), message);
        }
    ...
    public void setClientMessageKey(String clientMessageKey) {
