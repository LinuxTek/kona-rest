...
public class RestExceptionHandler extends AbstractHandlerExceptionResolver implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        logger.debug("RestExceptionHandler initialized:  order: " + getOrder());
    }
    ...
    protected ModelAndView doResolveException(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex) {
    	logger.debug("doResolveException called for exception: " + ex.getMessage());
    	
    	try {
    		return _doResolveException(request, response, handler, ex);
